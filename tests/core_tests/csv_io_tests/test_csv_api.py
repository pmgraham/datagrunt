...
class TestCSVSchemaReportAIGenerated:
    ...
    def test_csvschema_initialization(self, sample_csv):
        ...
        schema_gen = CSVSchemaReportAIGenerated(sample_csv, engine="google", api_key="fake_key")
    ...
    def test_csvschema_invalid_engine(self, sample_csv):
        ...
        with pytest.raises(ValueError) as exc_info:
            CSVSchemaReportAIGenerated(sample_csv, engine="invalid", api_key="fake_key")
    ...
    def test_csvschema_google_search_restriction(self, sample_csv):
        ...
        with pytest.raises(ValueError) as exc_info:
            CSVSchemaReportAIGenerated(sample_csv, engine="google", api_key="fake_key", ground_google_search=True)
