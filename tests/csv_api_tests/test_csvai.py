...
class TestCSVSchemaReportAIGenerated:
    ...
    def test_create_engine(self, mock_factory_class):
        ...
        mock_factory_class.assert_called_once_with(
            "test_key", "google", temperature=0.7
        )
    ...
    def test_generate_csv_schema_report_default_prompt(self, mock_factory_class, mock_prompts, mock_csv_sample_class):
        ...
        mock_prompts.CSV_SCHEMA_PROMPT.format.assert_called_once_with(
            csv_sample_string="sample,csv,data\n1,2,3"
        )
    ...
    def test_generate_csv_schema_report_default_system_instructions(self, mock_factory_class, mock_prompts, mock_csv_sample_class):
        ...
        mock_engine.generate_content.assert_called_once_with(
            model="model",
            prompt="custom prompt",
            system_instruction="default instructions"
        )
